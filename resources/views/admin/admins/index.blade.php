    ...
    <div class="col">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col">
                        <table class="table table-responsive table-sm table-bordered align-middle table-fit">
                            ...
                            <tr>
                                ...
                                <th class="text-center px-3" scope="col">Role</th>
                                <th class="text-center px-3" scope="col">Permission</th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center px-3">
                                            <div class="d-flex px-2">
                                                ...
                                                <form id="delete-form-{{$item->id}}" action="{{route('admin.admins.destroy', $item->id)}}" method="post">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                            </div>
