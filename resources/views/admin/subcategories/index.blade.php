    ...
    <div class="col">
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                <h4 style="color:#EE877C">Subcategory</h4>
                <div>
                    <a class="btn btn-sm btn-primary" href="{{route('admin.subcategories.create')}}">
                        Create
                    </a>
                    ...
                    <a class="btn btn-sm btn-info" href="{{route('admin.subcategories.indexWithDeleted')}}">
                        All With Deleted
                    </a>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center px-3">
                                            <div class="d-flex px-2">
                                                <a href="{{route('admin.subcategories.edit', $item->id)}}" class="btn btn-sm btn-outline-primary" title="Edit" style="margin-right: 5px">
                                                ...
                                                <form id="delete-form-{{$item->id}}" action="{{route('admin.subcategories.destroy', $item->id)}}" method="post">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                            </div>
